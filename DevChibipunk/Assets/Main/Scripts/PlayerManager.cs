...
public class PlayerMovement : MonoBehaviour
{
    ...
    void MoverJugador()
    {
        ...
        rb.linearVelocity = transform.TransformDirection(nuevaVelocidad);
    }

    void Saltar()
    {
        // Detecta si est� en el suelo
    ...
    {
        // Dibuja la esfera de detecci�n de suelo (visible solo en modo editor)
